class ModalOverlay {
  selectors = {
    ...
    modalOverlayInner: "[data-js-modal-overlay-inner]",
  ...
  stateClasses = {
    ...
    modalOverlayInnerIsActive: "modal-overlay__inner--is-active",
  ...
  constructor() {
    ...
    this.modalOverlayInnerElement = document.querySelector(this.selectors.modalOverlayInner);
